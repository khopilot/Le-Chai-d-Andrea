...
export default function PageHero({ label, title, subtitle }: PageHeroProps) {
  return (
    <section className="relative z-[2] flex min-h-[40vh] items-center justify-center overflow-hidden bg-[radial-gradient(ellipse_at_20%_50%,rgba(92,26,26,0.3)_0%,transparent_60%),linear-gradient(160deg,#0d0a07_0%,#1a0f0a_40%,#0f0b08_100%)] pb-16 pt-24">
